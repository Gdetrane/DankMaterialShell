                    ...
                    Column {
                        ...
                        DankFilterChips {
                            ...
                            model: [
                                ...
                                { "label": I18n.tr("All", "Tailscale filter: all devices"), "count": TailscaleService.peers.length }
                            ]
                        ...
                        Column {
                            ...
                            property var filteredPeers: {
                                if (detailRoot.searchQuery.length > 0)
                                    return TailscaleService.searchPeers(detailRoot.searchQuery) || [];
                                switch (detailRoot.filterIndex) {
                                case 0: return TailscaleService.getMyOnlinePeers() || [];
                                case 1: return TailscaleService.getOnlinePeers() || [];
                                case 2: return TailscaleService.peers || [];
                                default: return [];
                                }
                            }
